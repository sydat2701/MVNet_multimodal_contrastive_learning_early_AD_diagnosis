...
teacher_path = '/home/id202388544/dat/MVNet_fol/MVNet_surfteacher/teacher/teacher_weights/cn_mci_adni23_1head'
contras_weight_path = '/home/id202388544/dat/MVNet_fol/MVNet_surfteacher_contras/contras_base_extract_net/weights_contras_base_adni23'
...
def train(num_epoch, device, criterion, config, weight_path, lr, dataloader_train, dataloader_val, \
    ...
    from extract_net_extend_3modal_adni23_1head_noteacher import MVNetContras
    model = MVNetContras(teacher_weight_path, contras_weight_path, str(fol_idx))
    ...
    for epoch in range(num_epoch):
        ...
        for inputs, labels in dataloader_train:
            ...
            y_pred, y_pred_mri, y_pred_amyloid, y_pred_tau = model(mri, amyloid, tau)
        ...
        epoch_train_loss =0
        epoch_train_acc=0
        print("train_acc:", np.round(train_accuracy, 4), "train_loss:", np.round(train_loss,4))
        num_iters_train=0
        #---------------------------------------VALIDATION---------------------------
        epoch_val_acc = 0
        epoch_val_loss=0
...
def main():
    ...
    log_path = './logs/adni23_mri_tau_amyloid_surf_contras_4clf_seed{}_cnmci_1head_fextra_noteacher'.format(seed)
    num_folds = 5
    num_epoch=100
    is_cosinelr = True
    is_early_stop = True
    ...
    weight_path = 'teacher/weights/adni23_mri_tau_amyloid_surf_contras_4clf_seed{}_cnmci_1head_fextra_noteacher'.format(seed)

    data_path = '/home/id202388544/dat/Data_ADNI23_ANTS'

    batch_size = 8
    lr = 0.0003
    tasks = ['cn_mci']

    X, y = np.load('/home/id202388544/dat/surface/data/ADNI23/data_fsaverage.npy').astype('float32'), np.load('/home/id202388544/dat/surface/data/ADNI23/labels.npy')
