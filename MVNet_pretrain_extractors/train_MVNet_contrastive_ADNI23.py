...
def get_subs_labels_for_fol(subs, y, fol):
    val_subs = np.load('teacher/val_sub/split_sub_val_ADNI23/'+str(fol)+'.npy', allow_pickle=True)
...
def main():
    ...
    log_path = './logs/seed{}_att'.format(seed)
    num_folds = 5
    num_epoch=150
    is_cosinelr = False
    is_early_stop = True
    ...
    weight_path = 'teacher/weights/seed{}__att'.format(seed)
